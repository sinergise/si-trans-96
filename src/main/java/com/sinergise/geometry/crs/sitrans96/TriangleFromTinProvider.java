...
public class TriangleFromTinProvider implements TriangleProvider {
	QuadEdgeSubdivision delaunay;
	TriangularTransformationPoint[] points;
	
	public TriangleFromTinProvider(TriangularTransformationPoint[] pointData) {
		this.points = pointData;
		this.delaunay = buildTriangles(pointData);
	}
	
	public TriangleFromTinProvider inverse() {
		...
		return new TriangleFromTinProvider(invPoints);
	}
